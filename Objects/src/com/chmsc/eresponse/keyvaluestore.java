...
public class keyvaluestore extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.chmsc.eresponse.keyvaluestore");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.chmsc.eresponse.keyvaluestore.class).invoke(this, new Object[] {null});
        else
